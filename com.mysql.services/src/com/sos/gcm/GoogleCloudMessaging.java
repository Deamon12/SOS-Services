...
public class GoogleCloudMessaging {
	...
	public String sendMessage(String questionId, int type, String userId, List<String> devices) throws IOException{
		...
		if (devices.isEmpty()) {
			...
			Message message = new Message.Builder().addData("type", ""+type).addData("userId", userId).addData("questionId", questionId).build();
